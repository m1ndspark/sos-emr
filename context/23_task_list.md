...
| Reprice Empath Super STAT: the July run stamped it at $200 (AccentCare's rate) instead of Empath's $400 on four visits (REF-072326-1423, REF-072826-1466, REF-073026-1489, REF-072726-1459), under-billing premiums by $800. backfill_pvs_premium_fees only fills blanks so it will not fix the non-blank $200; needs a premium repricing pass (reprice_draft_pvs equivalent), then void-and-rebill any already-invoiced visit. Sequence BEFORE the Empath capped re-batch above so the re-run picks up $400. See context/30 section 2. | Neil / cchat | OPEN | Y | 2026-08-08 |
